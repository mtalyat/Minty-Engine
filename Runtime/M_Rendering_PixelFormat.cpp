...
std::string minty::rendering::to_string(PixelFormat const value)
{
    switch (value)
    {
...
PixelFormat minty::rendering::from_string_texture_builder_pixel_format(std::string const& value)
{
