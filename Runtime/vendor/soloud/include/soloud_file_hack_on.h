...
extern Soloud_Filehack * Soloud_Filehack_fopen(const char *aFilename, char const *aMode);
extern int Soloud_Filehack_fopen_s(Soloud_Filehack **f, const char* aFilename, char const* aMode);
